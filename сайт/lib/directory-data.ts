...
export const materialsLinks: DirectoryLink[] = [
  ...
  },
  {
    id: "price-list",
    title: "Прайс",
    description: "Актуальний прайс-лист мережі перукарень «Лайк»",
...
export const toolsLinks: DirectoryLink[] = [
  ...
  },
  {
    id: "website",
    title: "Сайт",
    description: "Публічний сайт мережі перукарень «Лайк»",
  ...
  },
  {
    id: "canva",
    title: "Canva",
    description: "Усі дизайни мережі перукарень «Лайк»",
